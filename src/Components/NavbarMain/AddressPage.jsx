                    ...
                    <div className="w-[650px]">
                        <div className="px-4 md:px-6">
                            <div className="flex-1 pb-7">
                                <label for="country" className="text-xs font-medium opacity-60 block mb-2">
                                    Full Name
                                </label>
                                <div className="">
                                    <input type="text"
                            ...
                            <div className="md:flex md:gap-4">
                                <div className="flex-1">
                                    <label className="text-xs font-medium opacity-60 block mb-2">City</label>
                                    <div className="">
                                    <input type="text"
                                    placeholder="City"
                                     className="border text-black h-12 lg:h-14 text-sm lg:text-base font-bold rounded-md  p-1 w-full pl-3 outline-none border-[#979797] opacity-100 "/>
                                ...
                                <div className="flex-1">
                                    <label className="text-xs font-medium opacity-60 block mb-2">State</label>
                                    <div className="">
                                    <input type="text"
                                    placeholder="State"
                                     className="border text-black h-12 lg:h-14 text-sm lg:text-base font-bold rounded-md  p-1 w-full pl-3 outline-none border-[#979797] opacity-100 "/>
                            ...
                            <div className="flex gap-6 md:w-4/5 m-auto mt-10 my-2">
                                <button type="submit" className="submit fixed md:static md:z-0 z-50 bottom-0 uppercase 
                                cursor-pointer lg:h-14 h-14 lg:text-xl w-full flex-1 border-none outline-none flex justify-center items-center md:rounded-md text-white bg-[#989898]">
                                    SAVE ADDRESS
                                </button>
                                <button className="hidden md:flex border border-[#51cccc] text-[#51cccc] 
                                rounded-md justify-center items-center lg:text-xl flex-1">CANCEL</button>
                            </div>
                        </div>
                    </div>
                </form>
