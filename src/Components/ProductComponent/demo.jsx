      ...
      <div className="flex justify-center">
        <div className="w-85 flex flex-col justify-left mt-[70px] ">
          {loading ? (
            ...
            <div className="">
              <div className="my-[30px] pl-[10px]   flex flex-col justify-left  max-[768px]:justify-center max-[768px]:items-center ">
                {/* heading wrapper */}
                ...
                <div className="flex mt-[40px] justify-center ">
                  ...
                  <div className="relative pl-[5px] w-[80%]  border-[1px] flex flex-col max-[768px]:flex-row ">
                    {!isMobile && tempArr?.length > 0 && (
