    ...
    return(
        ...
        <div className="w-[45%] ">
            <div className="relative rounded-md px-4 mb-4 h-12 flex items-center bg-[#fdd835]">
                ...
                </span><img className="absolute ml-[145px] pb-[2px]" src={tribe_yellow_img} alt="" />
            </div>
            ...
            <div className="p-2 border text-xs">
                <div className="rounded-md p-2 bg-[rgba(66,162,161,.1)] text-[#42a2a2] flex items-center 
                justify-between">
                    <span>Apply Coupon / Gift Card / Referral</span>
                    <span className="font-bold flex items-center gap-1">Redeem
                    <img src={arrow_img} alt="" />
                    </span>
                </div>
            </div>
         <div className="md:sticky md:top-24 border bg-[rgba(0,0,0,.04)]  mb-8 pb-8">
          <p className="py-3 px-5 text-[12px] text-[#333] tracking-wider bg-[#0000000a] font-bold ">PRICE SUMMARY</p>
         <div className="bg-white font-medium">
            ...
            <div className="px-4 pb-12 border-b">
                <div className="flex justify-between pb-3 text-[13px] text-[#333]">
                  <p className="font-bold text-[15px] tracking-wider">Subtotal</p>
        ...
        <button className="cursor-pointer mr-4 h-10 w-72 font-medium 
        border-none outline-none flex justify-center items-center rounded-md text-white bg-[#42a2a2] hover:bg-opacity-80">
         ...
         <div className=" py-10 flex justify-center gap-2 text-center">
            <div className="flex flex-col gap-1 items-center">
                <img className="w-10 h-10 object-cover" src={badge_trust_img} alt="" />
                <span className="font-semibold text-[13px] text-[#8f98a9]">100% SECURE PAYMENTS</span>
            </div>
            <div className="flex flex-col gap-1 items-center">
                <img className="w-10 h-10 object-cover" src={easy_returns_img} alt="" />
                <span className="font-semibold text-[13px] text-[#8f98a9]">EASY RETURNS & QUICK REFUNDS</span>
            </div>
            <div className="flex flex-col gap-1 items-center">
                <img className="w-10 h-10 object-contain" src={globe_img} alt="" />
                <span className="font-semibold text-[13px] text-[#8f98a9]">SHIPPING GLOBALLY</span>
            </div>
            </div>
         </div>
        </div>
